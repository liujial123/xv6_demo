...
在本次实验中, 新增了几个关于网络传输的代码源文件, 包括**[kernel/net.h](https://zhida.zhihu.com/search?content_id=228573956&content_type=Article&match_order=1&q=kernel%2Fnet.h&zhida_source=entity)**, **[kernel/net.c](https://zhida.zhihu.com/search?content_id=228573956&content_type=Article&match_order=1&q=kernel%2Fnet.c&zhida_source=entity)**等等. 但他们都是更上层的协议的实现. 在本次实验中, 我们只需要关心**[kernel/e1000.c](https://zhida.zhihu.com/search?content_id=228573956&content_type=Article&match_order=1&q=kernel%2Fe1000.c&zhida_source=entity)**里的两个留空函数的实现.

**e1000_transmit**是给了一个新的**packet**, 我们需要在ring里找到下一个空余位置, 然后把它放进去等待传输.
...
**e1000_recv**是需要遍历这个ring, 把所有新到来的**packet**交由网络上层的协议/应用去处理.
